    ...
    <footer className="bg-primary text-white py-12 border-t border-white/10">
      <div className="container mx-auto px-4">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            <h3 className="text-xl font-heading font-bold mb-3 text-white">Yard Bros Landscaping</h3>
          ...
          <div>
            <h3 className="text-xl font-heading font-bold mb-4 text-white">Contact Us</h3>
          ...
          <div>
            <h3 className="text-xl font-heading font-bold mb-4 text-white">Business Hours</h3>
          ...
          <div>
            <h3 className="text-xl font-heading font-bold mb-4 text-white">Quick Links</h3>
